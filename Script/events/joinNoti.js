...
module.exports.run = async function({ api, event }) {
  ...
  if (event.logMessageData.addedParticipants.some(i => i.userFbId == api.getCurrentUserID())) {
    ...
    api.sendMessage("চ্ঁলে্ঁ এ্ঁসে্ঁছি্ঁ  [ / ] 𝗥𝗔𝗡𝗔-𝗜𝗦𝗟𝗔𝗠𝗜𝗖-𝗕𝗢𝗧-এঁখঁনঁ তোঁমাঁদেঁরঁ সাঁথেঁ আঁড্ডাঁ দিঁবঁ..!", threadID, () => {
...
★ যেকোনো অভিযোগ অথবা হেল্প এর জন্য এডমিন 𝗥𝗔𝗡𝗔 𝗩𝗮𝗶 কে নক করতে পারেন ★
➤𝐌𝐞𝐬𝐬𝐞𝐧𝐠𝐞𝐫: https://m.me/100042211012809
➤𝐖𝐡𝐚𝐭𝐬𝐀𝐩𝐩: https://wa.me/01878840655

❖⋆═══════════════════════⋆❖
          𝐁𝐨𝐭 𝐎𝐰𝐧𝐞𝐫 ➢ 𝗥𝗔𝗡𝗔 𝗜𝘀𝗹𝗮𝗺`;
  ...
  try {
    ...
    let msg = (typeof threadData.customJoin === "undefined") ? `╭•┄┅═══❁🌺❁═══┅┄•╮
     আ্ঁস্ঁসা্ঁলা্ঁমু্ঁ💚আ্ঁলা্ঁই্ঁকু্ঁম্ঁ 
╰•┄┅═══❁🌺❁═══┅┄•╯
প্রিয় মেম্বার রানা ভাইয়ে পক্ষ থেকে 
