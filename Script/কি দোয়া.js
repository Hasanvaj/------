...
module.exports.run = () => {
  ...
  let dirMaterial = __dirname + `/cache/doya/`; 
  if (!existsSync(dirMaterial + "cache" + "12doya")) mkdirSync(dirMaterial, { recursive: true });
  ...
  let { threadID, messageID, senderID, body } = event;
    switch(handleReply.type) {
      ...
      api.sendMessage({
        ...
        attachment: createReadStream(__dirname + `/cache/doya/doya1.jpg`)
      }, threadID, messageID);
      break;
    ...
    case "2":
      ...
      api.sendMessage({
        ...
        attachment: createReadStream(__dirname + `/cache/doya/doya2.jpg`)
      },threadID, messageID);
      break;
    ...
    case "3":
      ...
      api.sendMessage({
        ...
        attachment: createReadStream(__dirname + `/cache/doya/doya3.jpg`)
      }, threadID, messageID); 
      break;
    ...
    case "4":
      ...
      api.sendMessage({
        ...
        attachment: createReadStream(__dirname + `/cache/doya/doya4.jpg`)
      }, threadID, messageID); 
      break;
    ...
    case "5":
      ...
      api.sendMessage({
        ...
        attachment: createReadStream(__dirname + `/cache/doya/doya5.jpg`)
      }, threadID, messageID); 
      break;
  ...
  let { threadID, messageID, senderID, body } = event;
    ...
    case "6":
      ...
      api.sendMessage({
        ...
        attachment: createReadStream(__dirname + `/cache/doya/doya6.jpg`)
      }, threadID, messageID); 
      break;
    ...
    case "7":
      ...
      api.sendMessage({
        ...
        attachment: createReadStream(__dirname + `/cache/doya/doya7.jpg`)
      }, threadID, messageID); 
      break;
    ...
    case "8":
      ...
      api.sendMessage({
        ...
        attachment: createReadStream(__dirname + `/cache/doya/doya8.jpg`)
      }, threadID, messageID); 
      break;
    ...
    case "9":
                api.unsendMessage(handleReply.messageID);
      api.sendMessage({
        body: "কবর জিয়ারত এর শঠিক নিয়ম ও দোয়া-!!❤️🤲\n\n১ বার সূরা ফাতিহা\n১ বার সূরা আন নাস \n১ বার সূরা ফালাক \n ৩ বার সূরা ইখলাস\n১ বার সূরা কাফিরুন \n২ বার সূরা তাকাছুর\n ১১ বার দুরুদশরিফ \n১১ বার আস্তাগফিরুল্লাহ \n এবং শেষে দোয়া করবেন\n\n আর অবশ্যই পশ্চিম দিকে তাকিয়ে সকল দোয়া ও সূরা পরবেন কবোরের দিকে তাকিয়ে নয়-!!🌸😊", attachment: createReadStream(__dirname + `/cache/doya/doya9.jpg`)
      }, threadID, messageID); 
      break;
    ...
    case "10":
                api.unsendMessage(handleReply.messageID);
      api.sendMessage({
        body: "رَبِّ هَبْ لِي مِن لَّدُنْكَ ذُرِّيَّةً طَيِّبَةً إِنَّكَ سَمِيعُ الدُّعَاء \n\nউচ্চারণ : রাব্বি হাবলি মিল্লাদুনকা যুরিরয়্যাতান ত্বাইয়্যিবাহ, ইন্নাকা সামিউদ দুআ।\n\n অর্থ : হে আমাদের প্রতিপালক! তোমার পক্ষ থেকে আমাকে পূতপবিত্র সন্তান দান করো। নিশ্চয়ই তুমি প্রার্থনা কবুলকারী। (সুরা : আলে ইমরান, আয়াত : ৩৮)।", attachment: createReadStream(__dirname + `/cache/doya/doya10.jpg`)
      }, threadID, messageID); 
            break;
      ...
      api.sendMessage({
        ...
        attachment: createReadStream(__dirname + `/cache/doya/doya11.jpg`)
      }, threadID, messageID); 
      break;
      ...
      api.sandmessage({
        ...
        attachment: createReadStream(__dirname + `/cache/doya/doya12.jpg`)
      }, threadID, messageID); 
            break;
