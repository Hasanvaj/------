...
module.exports.handleEvent = async function ({ api, event, Users }) {
  ...
  const responses = {
    ...
    "🥰,💖,🤍,😍,❤️,": "ভালোবাসা নামক আবলামি করতে চাইলে বাবু ইনবক্সে যা পাগল ছাগল 🔪😾😾",
    ...
    "assalamualaikum,আসসালামু আলাইকুম": "𝗪𝗮𝗹𝗮𝗸𝘂𝗺 𝗮𝘀𝘀𝗮𝗹𝗮𝗺💖প্রিয় মেম্বার",
    "zx": "https://github.com/shahadat-sahu/SHAHADAT-CHAT-BOT.git",
    "bot kiss me,kiss de bot,ummma jan,ummma bot,": "মেয়ে হলে বাবু কে দাও ছেলে হলে সামনে তো সর🔪😾 🤭,umma too jan💋,uff sei shad🥵,",
    ...
    "tor name ki,bot tor name ki,বট তোর নাম কি,tor boss name ki,": "MY NAME IS ─꯭─⃝[ / ] • BABU ☢️_𖣘 -𝐁𝐎𝐓 ⚠️,amar boss name Rana Islam💖🌺",
    "pic de": "এন থেকে সর দুরে গিয়া মর😒",
    "cudi": "এত চোদা চুদি করস কেনো..!🥱🌝🌚",
    "bot ja to,bot left ne,ei bale bot ber kor,add diche ke bot": "রাগ করে না ভাই বন আমি তো রোবট তাই এমন হচ্ছে 🥰,আমি তো তোমাদের হাসানো জন্য আসছি🤖💬,আমি চলে গেলে যদি ভালো হয় তাহলে কিক দাও🤖💬",
    "heda": "এতো রাগ শরীরের জন্য ভালো না 🥰",
    "😁": "হাসলে তোরে মফিজে মতো লাগে..!🌚🤣",
    "bot biye korbi,bot lucca,tor boss rana luccha,aso jan,tui de,": "ভালোবাসা নামক আবলামী করতে চাইলে Boss বাবু এর ইনবক্সে গুতা দিন 😘,ami ki tore bolchi amj valo, জান রাত ১২টা পরে কল দিও🤦‍♂️🐸,সর আবাল😾",
    "bot ki korch": "তোমার কথা ভাবতে ছি জানু",
    "bot koi, বট কই গেলো,oii bot,Bot koi,": "হ্যাঁ সব কেমন আছেন আপনার ওই খানে উম্মাহ 😘😽🙈,এতো ডাকো কেন প্রেমে পরছো নাকি🙊🤖,চলে আাছি জান বলো,এইতো জান আমি"
  };
