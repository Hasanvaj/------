...
module.exports.handleEvent = async function ({ api, event, Users }) {
  ...
  const responses = {
    "bot miss you": "অরেক বেডারে Miss না করে xan মেয়ে হলে বস রানা রে হাঙ্গা করো😶👻😘",
    ...
    "Bot": "Bolo bou💬,bolo jan🤖,ei to jan ami🤭,tumake miss korchi jan😘, bolo babu💬,",
    ...
    "bot Love you": "ভালোবাসা নামক আবলামী করতে চাইলে Boss বাবু এর ইনবক্সে গুতা দিন 😘",
